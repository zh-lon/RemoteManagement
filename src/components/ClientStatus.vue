<template>
  <el-card class="client-status-card" header="客户端状态">
    <div class="client-status">
      <div v-for="(typeClients, type) in clientStatus" :key="type" class="client-type">
        <h4 class="type-title">
            ...
            <div class="guide-content">
              ...
              <div class="client-guide">
                <div class="guide-item">
                  ...
                  <p><strong>下载地址：</strong> <a href="https://www.netsarang.com/zh/xshell/" target="_blank">https://www.netsarang.com/zh/xshell/</a></p>
                </div>
                
                <div class="guide-item">
                  <h4>SecureCRT</h4>
                  <p>专业的SSH/Telnet客户端，适合企业用户。</p>
                  <p><strong>下载地址：</strong> <a href="https://www.vandyke.com/products/securecrt/" target="_blank">https://www.vandyke.com/products/securecrt/</a></p>
                </div>
                
                <div class="guide-item">
                  <h4>PuTTY (免费)</h4>
                  <p>轻量级的SSH客户端，完全免费。</p>
                  <p><strong>下载地址：</strong> <a href="https://www.putty.org/" target="_blank">https://www.putty.org/</a></p>
                </div>
              </div>
            </div>
          </el-tab-pane>
            ...
            <div class="guide-content">
              ...
              <div class="client-guide">
                <div class="guide-item">
                  ...
                  <p><strong>下载地址：</strong> <a href="https://www.netsarang.com/zh/xftp/" target="_blank">https://www.netsarang.com/zh/xftp/</a></p>
                </div>
                
                <div class="guide-item">
                  <h4>WinSCP (免费)</h4>
                  <p>Windows平台优秀的SFTP/FTP客户端，完全免费。</p>
                  <p><strong>下载地址：</strong> <a href="https://winscp.net/" target="_blank">https://winscp.net/</a></p>
                </div>
                
                <div class="guide-item">
                  <h4>FileZilla (免费)</h4>
                  <p>跨平台的FTP客户端，开源免费。</p>
                  <p><strong>下载地址：</strong> <a href="https://filezilla-project.org/" target="_blank">https://filezilla-project.org/</a></p>
                </div>
              </div>
            </div>
          </el-tab-pane>
            ...
            <div class="guide-content">
              ...
              <div class="client-guide">
                <div class="guide-item">
                  ...
                  <p><strong>下载地址：</strong> <a href="https://www.radmin.com/" target="_blank">https://www.radmin.com/</a></p>
                </div>
                
                <div class="guide-item">
                  <h4>RealVNC</h4>
                  <p>经典的VNC客户端，跨平台支持。</p>
                  <p><strong>下载地址：</strong> <a href="https://www.realvnc.com/" target="_blank">https://www.realvnc.com/</a></p>
                </div>
                
                <div class="guide-item">
                  <h4>TightVNC (免费)</h4>
                  <p>轻量级的VNC客户端，完全免费。</p>
                  <p><strong>下载地址：</strong> <a href="https://www.tightvnc.com/" target="_blank">https://www.tightvnc.com/</a></p>
                </div>
              </div>
            </div>
          </el-tab-pane>
...
const clientStatus = ref<Record<string, Array<{
  name: string
  executable: string
  description: string
  available: boolean
...
const refreshStatus = async () => {
  checking.value = true
  try {
    const availableClients = await connectionService.getAvailableClients()
    ...
    Object.entries(SUPPORTED_CLIENTS).forEach(([type, clients]) => {
      ...
      status[typeKey] = clients.map(client => ({
        ...client,
        available: availableClients[type as ConnectionType]?.includes(client.executable) || false
      }))
    })
